        ...
        <section>
            <div class="card spaceCadet text-center pb-2" style="width: 30rem; height: full">
                <div class="card-body">
                    ...
                    <form action="{{ route('log') }}" class="row row-cols-1" method="POST">
                        @csrf
                    ...
                    <div class="text-start fs-6 mt-3">
                        <a href="{{ route('registrasi') }}" id="registrasi">Belum Punya akun? Silahkan Registrasi.</a>
                    </div>
                </div>
            </div>
        </section>
